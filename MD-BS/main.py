...
ap.add_argument("-m", "--min-area", type=int, default=1000, 
        help="Minimum area in pixels difference to be considered actual motion.")
ap.add_argument("-t", "--thresh", default=100, type=int,
...
while True:
    ...
    # Preprocess frame:
    # Resize to have a width of 600px. Improves speed without sacrificing accuracy
   ...
   # blurred_frame = cv2.GaussianBlur(grayscale_frame, (21, 21), 0)
    ...
    font_color = (0,220, 0) if status == 'No Motion!' else (0, 0, 220)
